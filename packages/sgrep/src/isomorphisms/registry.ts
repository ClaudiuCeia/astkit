...
export const DEFAULT_ISOMORPHISM_RULES: readonly IsomorphismRule[] = [redundantParenthesesRule];

export const UNSAFE_ISOMORPHISM_RULES: readonly IsomorphismRule[] = [
