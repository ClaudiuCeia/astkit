export { searchProject } from "./sgrep.ts";
...
export {
  ...
  UNSAFE_ISOMORPHISM_RULES,
  expandPatternIsomorphisms,
} from "./isomorphisms/index.ts";
...
export type { FormatSearchOutputOptions, SearchCommandFlags } from "./command.ts";
